...
{
    /*
     * Функция выбирает ключевые слова в соответствии с полученным идентификатором статьи
     * Возвращает массив ключевых слов для статьи
     */
	...
	protected function selectArticleKeywords($article_id,$language='ru-RU')
	{
     ...
     /*
      * Функция выбирает список авторов для статьи
      * Возвращает массив объектов типа stdClass
      */
    ...
    /*
     * Функция выбирает литературы для статьи
    ...
    /*
     * Функция выбирает информацию о статье по идентификатору
     * возвращает массив объектов stdClass
     */
